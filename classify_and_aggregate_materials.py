...
classification_rules = {
    "主体及围护结构工程用材 Q1": {
        ...
        "保温隔热材料": {"keywords": ["保温材料", "保温板", "保温装饰一体化板","保温砂浆","轻集料混凝土","聚乙烯","挤塑聚苯板","聚氨酯","岩棉","玻璃棉","硅酸钙板","矿棉板","硅酸铝"]},
        "混凝土结构构件": {"keywords": ["混凝土构件"]}, # 需要更具体的关键词
        "钢结构构件": {"keywords": ["钢结构", "钢柱","钢梁","钢楼梯","钢板","钢格栅","钢板"]}, # 需要更具体的关键词
        "木结构构件": {"keywords": ["原木", "复合木", "重组材", "木结构"]},
        "轻钢龙骨": {"keywords": ["轻钢龙骨"]}, # 需要区分用途
        "节能门窗": {"keywords": ["门窗", "铝合金门窗","塑钢门窗","门窗玻璃","门窗型材","门窗五金","门窗配件"]}, # 假设所有门窗都节能，可能需要更细化
        "遮阳制品": {"keywords": ["遮阳"]},
        "建筑幕墙": {"keywords": ["玻璃幕墙"]},
